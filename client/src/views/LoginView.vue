...
async function handleSubmit() {
    ...
    try {
        ...
        mainStore.setUserDetails(login_info.user_details?.username ?? 'guest', login_info.user_details?.password ?? 'temp_pass', login_info.user_details?.email ?? 'no email found', login_info.user_details?.user_id ?? 'no user found') 
