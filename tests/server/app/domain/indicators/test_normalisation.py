...
normalisation = load_module("server/app/domain/indicators/normalisation.py")
normalise_value = normalisation.normalise_value
normalise_edge_attributes = normalisation.normalise_edge_attributes
normalise_graph_attributes = normalisation.normalise_graph_attributes
