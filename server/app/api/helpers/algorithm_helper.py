...
def nodes_csv_to_gdf(csv_path: str = "server/app/data/processed/nodes_table.csv", crs="EPSG:4326") -> gpd.GeoDataFrame:
...
def edges_csv_to_gdf(
    edges_csv: str = "server/app/data/processed/edges_table.csv",
    geom_csv: str = "server/app/data/processed/edges_geometry.csv",
    crs="EPSG:4326"
) -> gpd.GeoDataFrame:
