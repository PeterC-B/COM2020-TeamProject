...
def create_app():
    ...
    app.register_blueprint(create_graph_route_blueprint(get_graph_data_uc, get_graph_data_from_coords_uc, fetch_node_data_uc, fetch_edge_data_uc, fetch_location_name_uc))
